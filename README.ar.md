...
لهذا الإحباط صنعت **Panel 049**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **نقش أكثر ذكريات الصورة تأثيراً في طبعة خشبية منعشة محدودة الألوان**.
